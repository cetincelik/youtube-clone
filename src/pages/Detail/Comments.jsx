    ...
    <div className="my-6">
      {isLoading ? (
        ...
        <>
          ...
          <input
          type="text"
          className="w-full bg-transparent border-b border-gri 
           p-2 outline-none mb-5"
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex gap-5 items-center">
                  <div className="flex items-center gap-1
                   hover:bg-gray-700 p-1 rounded cursor-pointer">
                     <AiOutlineLike />
                  ...
                  {i.replyCount > 0 && (
                    <div className= "flex w-fit items-center p-1 rounded-md gap-2
                    text-blue-500 hover:bg-[#36639662] cursor-pointer">
                      <TiArrowSortedDown />
                      {i.replyCount} yanıt
                    </div>
                  )}
